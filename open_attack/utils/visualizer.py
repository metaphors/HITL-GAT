...
# - Tag: v2.1.1
# - File: /OpenAttack/utils/visualizer.py
...
def visualizer(idx, x_orig, y_orig, x_adv, y_adv, info, stream_writer, tokenizer, log_dir, key_len=25, val_len=10):
    """
    ...
    if x_adv is None:
        ...
        # modification begin
        with open(os.path.join(os.getcwd(), "data", log_dir, "log.txt"), "a") as log:
