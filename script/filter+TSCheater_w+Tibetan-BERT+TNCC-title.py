...
log_path = os.path.join("data", "Adv.TSCheater_w.Tibetan-BERT+TNCC-title", "log.txt")
data_path = os.path.join("data", "Adv.TSCheater_w.Tibetan-BERT+TNCC-title", "data_filtered.txt")
