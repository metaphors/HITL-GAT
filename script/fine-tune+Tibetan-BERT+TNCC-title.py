...
model = BertForSequenceClassification.from_pretrained("data/PLM.BERT.Tibetan-BERT",
                                                      num_labels=12, id2label=id2label, label2id=label2id)

training_args = TrainingArguments(
    output_dir="data/Victim.BERT.Tibetan-BERT+TNCC-title",
    eval_strategy="steps",
    save_strategy="steps",
    eval_steps=100,
    save_steps=100,
...
tokenizer = BertTokenizer.from_pretrained("data/PLM.BERT.Tibetan-BERT")
