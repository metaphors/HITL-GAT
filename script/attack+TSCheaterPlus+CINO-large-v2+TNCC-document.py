...
def main():
    ...
    victim = OpenAttack.loadVictim("XLM-RoBERTa.CINO-large-v2+TNCC-document")
    ...
    attack_eval.eval(dataset, visualize=True, progress_bar=True, log_dir="Adv.TSCheaterPlus.CINO-large-v2+TNCC-document")
