...
log_path = os.path.join("data", "Adv.TSCheaterPlus.Tibetan-BERT+TU_SA", "log.txt")
data_path = os.path.join("data", "Adv.TSCheaterPlus.Tibetan-BERT+TU_SA", "data_filtered.txt")
