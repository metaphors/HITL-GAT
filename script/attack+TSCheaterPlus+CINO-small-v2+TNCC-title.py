...
def main():
    ...
    victim = OpenAttack.loadVictim("XLM-RoBERTa.CINO-small-v2+TNCC-title")
    ...
    attack_eval.eval(dataset, visualize=True, progress_bar=True, log_dir="Adv.TSCheaterPlus.CINO-small-v2+TNCC-title")
