...
log_path = os.path.join("data", "Adv.TSAttacker.Tibetan-BERT+TNCC-title", "log.txt")
data_path = os.path.join("data", "Adv.TSAttacker.Tibetan-BERT+TNCC-title", "data_filtered.txt")
