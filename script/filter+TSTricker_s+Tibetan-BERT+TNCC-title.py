...
log_path = os.path.join("data", "Adv.TSTricker_s.Tibetan-BERT+TNCC-title", "log.txt")
data_path = os.path.join("data", "Adv.TSTricker_s.Tibetan-BERT+TNCC-title", "data_filtered.txt")
