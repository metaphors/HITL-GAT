...
model = XLMRobertaForSequenceClassification.from_pretrained("data/PLM.XLM-RoBERTa.CINO-large-v2",
                                                            num_labels=12, id2label=id2label, label2id=label2id)

training_args = TrainingArguments(
    output_dir="data/Victim.XLM-RoBERTa.CINO-large-v2+TNCC-title",
    eval_strategy="steps",
    save_strategy="steps",
    eval_steps=100,
    save_steps=100,
...
dataset = load_dataset("data/Dataset.Loader/TNCC-title.py")

tokenizer = XLMRobertaTokenizer.from_pretrained("data/PLM.XLM-RoBERTa.CINO-large-v2")
