...
def main():
    ...
    victim = OpenAttack.loadVictim("BERT.Tibetan-BERT+TNCC-title")
    ...
    attack_eval.eval(dataset, visualize=True, progress_bar=True, log_dir="Adv.TSCheaterPlus.Tibetan-BERT+TNCC-title")
