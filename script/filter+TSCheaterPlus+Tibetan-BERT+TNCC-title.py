...
log_path = os.path.join("data", "Adv.TSCheaterPlus.Tibetan-BERT+TNCC-title", "log.txt")
data_path = os.path.join("data", "Adv.TSCheaterPlus.Tibetan-BERT+TNCC-title", "data_filtered.txt")
